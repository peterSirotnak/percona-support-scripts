...
cd package-testing
git checkout PMM-7-add-nomad-tests-package-tests

export PMM_VERSION=3.2.0
export PMM_SERVER_IP=127.0.0.1

ansible-playbook -vvv --connection=local --inventory 127.0.0.1, --limit 127.0.0.1 playbooks/pmm3-client_integration_upgrade_custom_path.yml